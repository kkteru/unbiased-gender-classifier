...
from src.model import AutoEncoder_vanilla, LatentDiscriminator, PatchDiscriminator, Classifier
...
parser.add_argument("--name", type=str, default="default-vanilla",
...
parser.add_argument("--n_lat_dis", type=int, default=0,
...
parser.add_argument("--lambda_lat_dis", type=float, default=0,
...
# build the model
ae = AutoEncoder_vanilla(params).cuda()
